...
*    %rtp_1_load_data_product_sep(mpMode=S, mpOutScore=mn_short.all_ml_scoring);
*	 %rtp_1_load_data_product_sep(mpMode=T, mpOutTrain=mn_short.all_ml_train);
*	 %rtp_1_load_data_product_sep(mpMode=A, mpOutTrain=mn_short.all_ml_train, mpOutScore=mn_short.all_ml_scoring);
*
****************************************************************************
...
%macro rtp_1_load_data_product_sep(mpMode=A,
	...
	proc casutil;
	   droptable casdata="product_dictionary_ml" incaslib="mn_short" quiet;
	...
	proc casutil;
		droptable casdata="closed_pbo" incaslib="mn_short" quiet;
	run;
	...
	proc casutil;
		...
		droptable casdata="abt3_ml" incaslib="casuser" quiet;
		promote casdata="closed_pbo" incaslib="casuser" outcaslib="mn_short"; 
	run;
	...
	proc casutil;
		promote casdata="pbo_lvl_all" incaslib="casuser" outcaslib="mn_short";
		promote casdata="product_lvl_all" incaslib="casuser" outcaslib="mn_short";
		promote casdata="promo_ml" incaslib="casuser" outcaslib="mn_short";
	...
	proc casutil;
	  promote casdata="macro_transposed_ml" incaslib="casuser" outcaslib="mn_short";
	  droptable casdata="macro2_ml" incaslib="casuser" quiet;
	...
	proc casutil;
		promote casdata="weather" incaslib="casuser" outcaslib="mn_short"; 
	  droptable casdata="abt7_ml" incaslib="casuser" quiet;
	run;
	...
	*/
	...
	proc casutil;
		promote casdata='comp_transposed_ml_expand' incaslib='casuser' outcaslib='mn_short';
	...
	proc casutil;
		promote casdata="promo" incaslib="casuser" outcaslib="mn_short";
		promote casdata="promo_x_pbo_leaf" incaslib="casuser" outcaslib="mn_short";
		promote casdata="promo_x_product_leaf" incaslib="casuser" outcaslib="mn_short";
		promote casdata="promo_ml_trp_expand" incaslib="casuser" outcaslib="mn_short";
	...
	proc casutil;
	/* TEST */
	  promote casdata="product_dictionary_ml" incaslib="casuser" outcaslib="mn_short";
	...
	proc casutil;
		promote casdata="pbo_dictionary_ml" incaslib="casuser" outcaslib="mn_short";
