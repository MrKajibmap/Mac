...
*     %vf_prepare_ts_abt_pbo_old(mpPboSalAbt=dm_abt.pbo_sal_abt,
...
****************************************************************************/
%macro vf_prepare_ts_abt_pbo_old(mpPboSalAbt=dm_abt.pbo_sal_abt,
							mpPromoW1=dm_abt.promo_w1,
							mpPromoD=dm_abt.promo_d, 
							mpPboSales=dm_abt.TS_pbo_sales,
							mpWeatherW=dm_abt.weather_w );
	...
	data casuser.macro2;
		...
		drop pdt;
		set casuser.macro(rename=(period_dt=pdt));
		by name pdt;
...
%mend vf_prepare_ts_abt_pbo_old;