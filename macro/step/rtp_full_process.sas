...
*/
	...
	%M_ETL_REDIRECT_LOG(START, rtp_1_load_data_product_v1, Main);
	%M_LOG_EVENT(START, rtp_1_load_data_product_v1);
		%rtp_1_load_data_product_v1(mpMode=A,
					 mpOutTrain=casshort.all_ml_train,
					 mpOutScore=casshort.all_ml_scoring,
					 mpWorkCaslib=casshort);
	%M_LOG_EVENT(END, rtp_1_load_data_product_v1);
	%M_ETL_REDIRECT_LOG(END, rtp_1_load_data_product_v1, Main);
	...
	*	  mpOutScore	- выходная таблица набора для скоринга */
	...
	%M_ETL_REDIRECT_LOG(START, rtp_2_load_data_mastercode_v1, Main);
	%M_LOG_EVENT(START, rtp_2_load_data_mastercode_v1);
		%rtp_2_load_data_mastercode_v1( mpMode=A,
	...
	%M_LOG_EVENT(END, rtp_2_load_data_mastercode_v1);	
	%M_ETL_REDIRECT_LOG(END, rtp_2_load_data_mastercode_v1, Main);
	...
	*							); */
	...
	%M_ETL_REDIRECT_LOG(START, rtp_3_load_data_pbo_v1, Main);
	%M_LOG_EVENT(START, rtp_3_load_data_pbo_v1);
		%rtp_3_load_data_pbo_v1(mpMode=A, 
							mpOutTableTrain=casshort.pbo_train,
							mpOutTableScore=casshort.pbo_score,
						    mpWorkCaslib=casshort);
	%M_LOG_EVENT(END, rtp_3_load_data_pbo_v1);
	%M_ETL_REDIRECT_LOG(END, rtp_3_load_data_pbo_v1, Main);
