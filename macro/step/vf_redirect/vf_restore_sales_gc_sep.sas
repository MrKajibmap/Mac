%macro vf_restore_sales_gc_sep;
	...
	proc casutil;
		...
		save casdata="pmix_sales_rest" incaslib="mn_long" outcaslib="mn_long" replace compress;
	run;
	...
	proc casutil;
		...
		save casdata="pbo_sales_rest" incaslib="mn_long" outcaslib="mn_long" replace compress;
	run;
