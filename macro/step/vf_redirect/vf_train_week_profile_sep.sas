...
*
*  ПАРАМЕТРЫ:
*     mpOutWpGc		- выходная таблица wp_gc (по умолчанию dm_abt)
*
******************************************************************
*  Использует: 
*	  нет
...
*     %vf_train_week_profile_sep(mpOutWpGc=dm_abt.wp_gc);
*
****************************************************************************
*  02-07-2020  Борзунов     Начальное кодирование
****************************************************************************/
%macro vf_train_week_profile_sep(mpOutWpGc=dm_abt.wp_gc);
